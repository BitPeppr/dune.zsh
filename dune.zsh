quotes=(
	...
	— Muad'Dib: Family Commentaries, Princess Irulan"
	...
	— Private Reflections on Muad'Dib, Princess Irulan"
	...
	— Paul Muad'Dib"
	"Muad'Dib could indeed see the Future, but you must understand the limits of this power. The vision of time is broad, but when you pass through it, time becomes a narrow door. And always, he fought the temptation to choose a clear, safe course, warning \"That path leads ever down into stagnation.\"
	— Arrakis Awakening, Princess Irulan"
	...
	— The Stolen Journals"
	"There is in each of us an ancient force that takes and an ancient force that gives. A man finds little difficulty facing that place within himself where the taking force dwells, but it's almost impossible for him to see into the giving force without changing into something other than man.
	— Paul Muad'Dib"
	...
	— The Stolen Journals"
	"The trance-state of prophecy is like no other visionary experience. It is not a retreat from the raw exposure of the senses, but an immersion in a multitude of new movements. Things move. It is an ultimate pragmatism in the midst of Infinity, a demanding consciousness where you come at last into the unbroken awareness that the universe moves of itself.
	— The Stolen Journals"
	"You must remember that I have at my internal demand every expertise known to our history. To those who dare ask why I behave as I do, I say: With my memories, I can do nothing else. I am not a coward and once I was human.
	— The Stolen Journals"
	"Without change, something sleeps inside us and seldom wakes. The sleeper must awaken.
	— Duke Leto Atreides"
	...
	— Mentat Text One"
	"The life of a single human, as the life of a family or an entire people, persists as memory. My people must come to see this as part of their maturing process. Much that is stored can be lost in that chance play of accident which we call \"fate.\"
	— The Book of Leto"
	...
	"The greatest palatinate earl and the lowliest stipendiary serf share the same problem. You cannot hire a mentat or any other intellect to solve it for you. There's no writ of inquest or calling of witnesses to provide answers. No servant can dress the wound. You dress it yourself or continue bleeding for all to see.
	— Hayt, the ghola"
	...
	— Addenda to Orders in Council, Paul Muad'Dib"
	...
	"Above all else, the mentat must be a generalist, not a specialist. It is wise to have decisions of great moment monitored by generalists. Experts and specialists lead you quickly into chaos.
	— The Mentat Handbook"
	...
	"Life improves the capacity of the environment to sustain life. Life binds more energy into the system through the tremendous chemical interplay from organism to organism.
	— Imperial Planetologist Pardot Kynes"
	"The highest function of ecology is the understanding of consequences.
	— Pardot Kynes"
	"Life — all life — is in the service of life.
	— Pardot Kynes"
	"The thing the ecologically illiterate don't realize about an ecosystem is that it's a system. A system maintains a certain fluid stability that can be destroyed by a misstep in just one niche. A system has order, a flowing from point to point. If something dams the flow, order collapses.
	— Pardot Kynes"
	...
	"When did you last hear of a clerk giving his life for the company? Perhaps your deficiency rests in the false assumption that you can order men to think and cooperate. Men must want to do things of their own innermost drives. People, not commercial organizations or chains of command, are what make great civilizations work.
	— A Letter to CHOAM, attributed to The Preacher"
	"Church and State, scientific reason and faith, the individual and his community, even progress and tradition — all of these can be reconciled in the teachings of Muad'Dib. He taught us that there exists no intransigent opposites except in the beliefs of men.
	...
	"Let there be no doubt that I am the assemblage of our ancestors, the arena in which they exercise my moments. They are my cells and I am their body. This is the fravashi of which I speak, the soul, the collective unconscious, the source of archetypes, the repository of all trauma and joy.
	— The Stolen Journals"
	...
	"Enemies strengthen you. Allies weaken. I tell you this in the hope that it will help you understand why I act as I do in the full knowledge that great forces accumulate in my Empire with but one wish — the wish to destroy me.
	— The Stolen Journals"
	"Governments may rise and fall for reasons which appear insignificant. What small events! An argument between two women... which way the wind blows on a certain day... a sneeze, a cough. It is not always the majestic concerns of Imperial ministers which dictate the course of history.
	— The Preacher"
	...
	"Church and State, scientific reason and faith, the individual and his community — even progress and tradition — all of these can be reconciled. He taught us that there exists no intransigent opposites except in the beliefs of men. Anyone can rip aside the veil of Time.
	— The Preacher at Arrakeen"
	"No sweeteners will cloak some forms of bitterness. If it tastes bitter, spit it out. That's what our earliest ancestors did.
	— The Coda"
	"Enter no conflict against fanatics unless you can defuse them. Oppose a religion with another religion only if your proofs are irrefutable or if you can mesh in a way that the fanatics accept you as god-inspired.
	...
	— Leto Atreides II"
	"Some believe that you must compromise integrity with a certain amount of dirty work before you can put genius to work. Moneo says my solution is to stay within the sanctus, sending others to do my dirty work.
	— The Stolen Journals"
	"I have created what I intended — a powerful spiritual tension throughout my Empire. Few sense the strength of it. The only power I possess is the control of individual prosperity. That is the sum of all the things I do.
	— The Stolen Journals"
	...
	— The Stolen Journals"
	"I am all of God that need be seen. I am the word become a miracle. I am all of my ancestors. Is that not miracle enough? What more could you possibly want?
	— Leto Atreides II"
	...
	— The Stolen Journals"
	"In all of my universe I have seen no law of nature, unchanging and inexorable. This universe presents only changing relationships which are sometimes seen as laws by short-lived awareness. These fleshy sensoria which we call self are ephemera withering in the blaze of infinity.
	— The Stolen Journals"
	...
	— Leto Atreides II"
	"As long as there is life, every ending is a beginning. And I would save humankind, even from itself. This is why no death in the perpetuation of humankind can be a complete failure. This is why a birth touches us so deeply.
	— Leto Atreides II"
	"The prophet utters fateful words. You glimpse a thing \"destined to occur.\" But the prophetic instant releases something of infinite portent and power. The universe undergoes a ghostly shift. Thus, the wise prophet conceals actuality behind shimmering labels.
	— The Stolen Journals"
	...
	— The Stolen Journals"
	"Muad'Dib's teachings have become the playground of scholastics, of the superstitious and the corrupt. He taught a balanced way of life, a philosophy with which a human can meet problems arising from an ever-changing universe. He said humankind is still evolving, in a process which will never end.
	...
	"Either we abandon the long-honored Theory of Relativity, or we cease to believe that we can engage in continued accurate prediction of the future. How, then, do we explain the continued seeking after this visionary goal by respected scientists? How, then, do we explain Muad'Dib?
	— Lectures on Prescience by Harq al-Ada"
	"This was Muad'Dib's achievement: He saw the subliminal reservoir of each individual as an unconscious bank of memories going back to the primal cell of our common genesis. Muad'Dib set himself the task of integrating genetic memory into ongoing evaluation. Thus did he break through Time's veils, making a single thing of the future and the past.
	...
	"I will not argue with the Fremen claims that they are divinely inspired to transmit a religious revelation. It is their concurrent claim to ideological revelation which inspires me to shower them with derision. Short-term expediency always fails in the long-term.
	— The Preacher at Arrakeen"
	...
	— Stilgar"
	"This is the awe-inspiring universe of magic: There are no atoms, only waves and motions all around. This universe cannot be seen, cannot be heard, cannot be detected in any way by fixed perceptions. It is the ultimate void where no preordained screens occur upon which forms may be projected. You have only one awareness here — the screen of the magi: Imagination!
	...
	— The Lady Jessica, Wisdom of Arrakis"
	...
	"A sophisticated human can become primitive. What this really means is that the human's way of life changes. Old values change, become linked to the landscape with its plants and animals. When a human gains this knowledge and respect, that is called \"being primitive.\"
	...
	— Liet-Kynes, The Arrakis Workbook"
	"At the quantum level our universe can be seen as an indeterminable place, predictable in a statistical way only when you employ large enough numbers. Between that universe and a relatively predictable one, other forces come into play. For the in-between universe where we find our daily lives, that which you believe is a dominant force.
	— Analysis of the Tyrant, the Taraza File"
	"A man who reads only one book is more dangerous than a man who reads none.
	...
	— Words of an ancient philosopher, attributed by Harq al-Ada"
	...
	— Padishah Emperor Idriss I"
	"There are countless definitions and interpretations of a life well spent, and of the opposite. The same individual can be either demon or saint, and even shades of both.
	— The Wisdom of Muad'Dib, Princess Irulan"
	...
	— Cogitor Kwyna"
	"Science: the creation of dilemmas by the solutions of mysteries.
	— Norma Cenva"
	...
	— Zensunni fire poetry from Arrakis"
	"There's an unwritten compact between you and the reader. If someone enters a bookstore and sets down hard earned money for your book, you owe that person some entertainment and as much more as you can give.
	— Frank Herbert, Foreword to Heretics of Dune"
	...
	— Last words of Toure Bomoko"
	"Men, finding no answers to the sunnah now apply their own reasoning. All men seek to be enlightened. Religion is but the most ancient and honorable way in which men have striven to make sense out of God's universe. Scientists seek the lawfulness of events. It is the task of Religion to fit man into this lawfulness.
	— C.E.T. Liturgical Manual"
	"We were speaking of the throne, Majesty. When I am Duke in Arrakeen, do you think I'll have time to concern myself with every detail of governing? Do you think I wish to cut off my right arm?
	— Paul Muad'Dib to Stilgar"
	"I cannot let it be. Yet the storm was gathering.
	— Paul Muad'Dib, on the coming Jihad"
	"You cannot back into the future.
	— Paul Muad'Dib to Chani"
	...
	"The spirit of Muad'Dib is more than words, more than the letter of the Law that arises from his name. It is that inner outrage against the complacently powerful, against the charlatans and the dogmatic fanatics.
	— The Fedaykin Compact"
	"All Planetologists see life as expressions of energy and look for the overriding relationships. In small pieces, bits and parcels which grow into general understanding, the Fremen racial wisdom is translated into a new certainty.
	...
	— Paul Muad'Dib"
	"You think power may be the most unstable of all human achievements? Then what of the apparent exceptions to this inherent instability? Some families endure. Very powerful religious bureaucracies have been known to endure. Consider the relationship between faith and power.
	— The Stolen Journals"
	...
	"There is a man so wise, He jumped into a sandy place and burnt out both his eyes! And when he knew his eyes were gone, He offered no complaint. He summoned up a vision and made himself a saint.
	— Children's verse from History of Muad'Dib"
	"It is not always the same thing to be a good man and a good citizen.
	— Aristotle of Old Earth"
	"O you who know what we suffer here, do not forget us in your prayers.
	— Inscription over the exit of the Arrakeen landing field"
	...
	— Leto Atreides II, from His Voice"
	"Let me but imagine a topic and I have them in all of their glory — every image intact, every moan, every grimace. Joys of motherhood, and the birthing beds are mine. Serial baby smiles and the sweet cooings of new generations. The first walkings of toddlers and the first victories of youths brought forth for me to share. They tumble one upon another until I can see little else but sameness and repetition. Keep it all intact, I warn myself. Who can deny the value of such experiences? Ahhh, but it's the past. Don't you understand? It's only the past!
	— Reading from Leto's journals"
	...
	— Paul Muad'Dib to the Guild navigators"
	"Such a rich store of myths enfolds Paul Muad'Dib, the Mentat Emperor, and his sister, Alia. Their catastrophe was the catastrophe of all mankind. This work is dedicated, then, not to Muad'Dib or his sister, but to their heirs — to all of us.
	...
	— Bijaz to Hayt"
	"Odd as it may seem, great struggles such as the one you can see emerging from my journals are not always visible to the participants. Much depends on what people dream in the secrecy of their hearts. I have always been as concerned with the shaping of dreams as with the shaping of actions.
	— The Stolen Journals"
	"The Guild navigators, gifted with limited prescience, had made the fatal decision: they'd chosen always the clear, safe course that leads ever downward into stagnation.
	— Narrator"
	"You should never be in the company of anyone with whom you would not want to die.
	— Duncan Idaho, reciting a Fremen saying"
	...
	"Remember that there exists a certain malevolence about the formation of any social order. It is the struggle for existence by an artificial entity. Despotism and slavery hover at the edges. Many injuries occur and, thus, the need for laws.
	— The Stolen Journals"
	"I have seen it fulfilled thousands of times! People call it a power, a gift. It's an affliction! It won't let me leave my life where I found it!
	— Paul Muad'Dib"
	...
	— A letter to CHOAM, attributed to The Preacher"
	"It was the Fremen custom to treat distant people as hostile until they threw sand into the air. Thrown sand is a profound gesture. It says: We share the same burden. Sand is our only enemy.
	— Leto Atreides II"
	...
	— Hwi Noree"
	"Hwi helps me. We had something few experience. We were joined in our strengths rather than in our weaknesses. And look what it got you! Yes, and pray that you get the same!
	— Exchange between Leto Atreides II and Siona"
	"My Uncle Malky always said that love was a bad bargain because you get no guarantees. You're stupid. Love needs no guarantees.
	— Hwi Noree"
	"We witness a passing phase of eternity. Important things happen but some people never notice. Accidents intervene. You are not present at episodes. You depend on reports. And people shutter their minds. What good are reports?
	— Darwi Odrade"
	"Ultimately all things are known because we want to believe we know.
	— Zensunni koan"
	"Confine yourself to observing and you always miss the point of your own life. The object can be stated this way: Live the best life you can.
	— Darwi Odrade"
	"The army fosters technology, and technology breeds anarchy because it distributes the terrible machines of destruction. One man alone could create and apply enough violence to ravage an entire planet. It happened! Why do you think the computer became anathema?
	— Serena Butler"
	"There is a certain momentum to victory... and to defeat.
	— Iblis Ginjo"
	...
	— Duncan Idaho, the Swordsmaster of the Ginaz"
